...
/*small 15319828050*/
if($upmk=='mkmobile'){define('DEDEMOB', 'Y');}
...

{
    ...
    $nurl .= "&seltime=$seltime&sstime=$sstime&stime=".urlencode($stime)."&etime=".urlencode($etime)."&upmk=$upmk&mkvalue=$mkvalue&isremote={$isremote}&serviterm={$serviterm}";
