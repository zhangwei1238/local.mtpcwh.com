...
if ( ! function_exists('GetFileUrl'))
{
    ...
    $money=0, $filename='',$moresite=0,$siteurl='',$sitepath='')
    {
        ...
        {
            if($siteurl=='')
            {				/*small 15319828050*/				if(defined('DEDEMOB')){
					$siteurl = '';				}else{					$siteurl = $GLOBALS['cfg_basehost'];				}				/*small 15319828050 end*/
            }
            if($moresite==1)
            {
...
if ( ! function_exists('GetTypeUrl'))
{
    function GetTypeUrl($typeid,$typedir,$isdefault,$defaultname,$ispart,$namerule2,$moresite=0,$siteurl='',$sitepath='')
    {
        ...
        {
            if($siteurl=='') {			
                /*small 15319828050*/				if(defined('DEDEMOB')){					$siteurl = '';				}else{					$siteurl = $GLOBALS['cfg_basehost'];				}				/*small 15319828050 end*/
            }
            if($moresite==1 ) {
...
{/*small 15319828050*/	if(defined('DEDEMOB')){		return preg_replace("/http:\/\//i", $gurl) ? $gurl : $gurl;	}else{		return preg_replace("/http:\/\//i", $gurl) ? $gurl : $GLOBALS['cfg_basehost'].$gurl;	}/*small 15319828050 end*/
}
