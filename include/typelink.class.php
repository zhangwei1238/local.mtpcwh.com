...
class TypeLink
{
    ...
    function GetPositionLink($islink=true)
    {
        if ( defined('DEDEMOB') )
        {
            ...
            /*vale
            $indexpage = "<a href='".$this->indexUrl."m/'>".$this->indexName."</a>";    
            */
    ...
    function GetOneTypeUrl($typeinfos)
    {
        if ( defined('DEDEMOB') )
        {
            ...
            /*vale 
            return '/m'.GetTypeUrl($typeinfos['id'],MfTypedir($typeinfos['typedir']),$typeinfos['isdefault'],$typeinfos['defaultname'],
